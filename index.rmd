...
ggplot() +
  ...
  theme_minimal() +
  ylim(0,100) +
  labs(x = "Health", "Other Consumption") +
...
2. Notice that the curves slope downwards - this must necessarily be the case; as one increases their consumption of $C$, they will give up the other good that they were indifferent to, $H$.
...
Manipulate the graphs and take a look around. Here we can see that all of those two dimensional lines are really just <span style="color:#59b300">**projections of a much larger 3-dimensional utility function**</span>. And the true indifference curve is only limited by the amount of utility they can purchase.
<br>
...
As I said earlier, utility theory suggests that one will seek to maximize their utility in all situations. So, naturally, their must be some constraint else a consumer would consume indefinitely, which we know is not reality. And so it isn't hard to imagine that the consumer's constraint is often a set budget - a finite amount of money they have to spend. A budget, then, tells us how much we can spend and therefore we must <span style="color:#59b300">**maximize our utility within that constraint**</span>. 
<br>
